...
- Localize AppTextField clear button tooltip
- Localize AppTextField clear button tooltip
- Localize AppTextField clear button tooltip

### 🐛 Bug Fixes

- **cd**: Use GitHub Secrets for signing keys instead of local files
- **cd**: Fix syntax error in Copy signing files step
- **cd**: Skip Flutter setup action (pre-installed on self-hosted runner)
- **cd**: Remove changesNotSentForReview parameter for Google Play alpha track (#548)
- **auth**: Map GoogleSignInException to AuthException instead of DataException (#543)
- Prevent crashlytics Infinity/NaN toInt crash on FireDashboardScreen (#541)
- Improve investment detail screen UI - FAB z-index and segment control
- Use AuthException for GoogleSignInExceptions

### 📚 Documentation

- Overwrite ENGINEERING_REVIEW_REPORT.md with fresh analysis (#542)
- Fix markdown style in bolt.md
- Update engineering review report with codebase analysis
- Update engineering review report with codebase analysis

### 🔧 Miscellaneous

- Bump version code to 271 to avoid duplicate release code
- Point reusable CD workflow to main branch
- Bump version code to 269 to avoid duplicate release code
- Merge main and resolve conflict in bolt.md

## [3.70.15] - 2026-06-21

### 🐛 Bug Fixes

- Update CHANGELOG for v3.70.14+267 Crashlytics fixes release
- Add onTap to Semantics wrapper in TemplateSelector
- **update**: Resolve in-app update flows, resume checks, and context race condition
- Enable encryptedSharedPreferences for Android FlutterSecureStorage

### 📚 Documentation

- Update repository-wide engineering review report (#527)
- Update daily engineering review report (#516)
- Update PR merge summary with PRs #498 and #499
- Generate repository-wide engineering review report
- Add PR merge summary for 7 merged PRs
- Add automated repository review report
- Generate comprehensive engineering review report

### 🔧 Miscellaneous

- Add app-metadata.json standard configuration with correct package ID

## [3.70.13] - 2026-06-05

### ⚡ Performance

- Optimize diversification calculation to single pass O(N)
- Single loop optimization in IncomeTrendAnalyzer (#483)

### ✨ Features

- **core**: Implement unified modular CalculationEngine (#484)

### 🐛 Bug Fixes

- **cd**: Bump version to 3.70.12+264 to resolve Play Store duplicate
- **riverpod**: Remove ref.read() from build() methods (Rule 3.2)
- Remove lowercase engineering_review_report.md (Rule 10.4 - docs must be uppercase)
- Gracefully handle Google Sign-In cancellation PlatformExceptions
- Complete localization - Address CodeRabbit review per Rule 16.2 (#481)
- Clean Architecture violation and update golden tests (#480)
- Remove duplicate uppercase engineering review report files (Git case-sensitivity fix)
- Wrap Firebase/Google Auth exceptions in domain exceptions before logging to prevent Crashlytics noise

### 📚 Documentation

- Add comprehensive engineering review report (#485)
- Move markdown files to docs/ folder per Rule 10.4 (#482)
- Generate comprehensive engineering review report (#465)
- Generate enterprise engineering review report (#470)
- Generate comprehensive repository-wide engineering review report (#461)
- Generate engineering review report (#469)

### 🔧 Miscellaneous

- Add version 3.70.10 entry to CHANGELOG.md for release compliance

## [3.70.10] - 2026-06-01

### 🐛 Bug Fixes

- Wrap in-app update exceptions to dynamically skip Crashlytics reporting for environmental failures

## [3.70.9] - 2026-06-01

### 🐛 Bug Fixes

- Resolve Crashlytics update navigator crashes and timezone warnings (#473)

## [3.70.8] - 2026-05-30

### ♻️ Refactoring

- Migrate to centralized reusable workflows (#464)

### 👷 CI/CD

- Upgrade shared workflows to v1.1.9 to resolve build-path bug

## [3.70.7] - 2026-05-30

### 👷 CI/CD

- Align reusable composite actions reference version to v1.1.8

## [3.70.6] - 2026-05-30

### 👷 CI/CD

- Upgrade shared composite actions to v1.1.4 (#468)

## [3.70.5] - 2026-05-28

### 👷 CI/CD

- Make Slack notifications non-blocking with continue-on-error
- Add dry-run build step and slack notifications on failure

### 🔧 Miscellaneous

- Sync version with Google Play Store (3.70.4+256)

## [3.70.3] - 2026-05-28

### 🐛 Bug Fixes

- **in-app-update**: Resolve Firebase Crashlytics crashes and user denial warnings

### 👷 CI/CD

- Add Android build validation to catch Gradle configuration issues

## [3.70.2] - 2026-05-27

### 🐛 Bug Fixes

- Update shared workflow pinning to v1.0.2

## [3.70.1] - 2026-05-27

### 🐛 Bug Fixes

- Pin shared actions to v1.0.1 and use direct Slack webhook

## [3.70.0] - 2026-05-27

### ♻️ Refactoring

- Simplify CD workflow using shared composite actions

### ✨ Features

- Migrate CI/CD workflows to centralized GitHub Actions (#458)

### 🐛 Bug Fixes

- Remove double dollar sign in build number calculation
- Use correct Play Store credentials secret name
- Resolve keystore path relative to android directory
- Replace success() with job.status in Slack notification expressions
- **in-app-update**: Fix flexible update flow, initialization context … (#455)

### 📚 Documentation

- Add repository-wide engineering review report (#456)

### 🔧 Miscellaneous

- Address PR review feedback
- Bump version to 250 to skip already-used build number
- Trigger CD workflow with corrected keystore secrets
- Confirm Crashlytics issues resolved (#457)
