...
final goalsSummaryProvider = Provider<AsyncValue<GoalsSummary>>((ref) {
  ...
  return progressAsync.when(
    data: (progressList) {
      ...
      // Optimization: Single pass loop replacing multiple .where() calls
      ...
      final avgProgress = totalGoals > 0 ? totalProgressSum / totalGoals : 0.0;
...
final multiCurrencyGoalsSummaryProvider = FutureProvider<GoalsSummary>((
  ...
  final avgProgress = totalGoals > 0 ? totalProgress / totalGoals : 0.0;
