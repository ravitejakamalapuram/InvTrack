...
class PerformanceReportService {
  ...
  PerformanceReport generateReport({
    ...
    // Optimization: Single pass calculation for average XIRR and profitable count
    // replacing .map().toList(), .reduce(), .sort() and .where().length calls
    ...
    // Calculate median XIRR using the already sorted list in O(1) time
