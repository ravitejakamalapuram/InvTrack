...
class SmartInsightsService {
  ...
  List<SmartInsight> _generateDecliningAlerts(
    ...
    // Optimization: Pre-group cash flows by investmentId to avoid O(N*M) lookups inside the loop
    ...
    for (final investment in investments) {
      ...
      // Optimization: Calculate all totals in a single pass instead of multiple .where().fold() calls
