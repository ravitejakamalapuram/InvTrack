...
3. Consolidate `OverviewEmptyState` (`lib/features/overview/presentation/widgets/overview_empty_state.dart`), `GoalsEmptyState` (`lib/features/goals/presentation/widgets/goals_empty_state.dart`), and `InvestmentEmptyState` (`lib/features/investment/presentation/widgets/investment_list_states.dart`) into a unified `AppEmptyState` widget.
...
2. Top 10 duplication-removal opportunities.
   1. Empty state UI widgets (`GoalsEmptyState` (`lib/features/goals/presentation/widgets/goals_empty_state.dart`), `OverviewEmptyState` (`lib/features/overview/presentation/widgets/overview_empty_state.dart`), `InvestmentEmptyState` (`lib/features/investment/presentation/widgets/investment_list_states.dart`)).
