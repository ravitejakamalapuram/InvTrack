...
void main() {
  group('FileSignatureUtils', () {
    test('validateFileSignature returns false for empty bytes', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(bytes, 'file.pdf'),
        isFalse,
      );
    });
    ...
    test('validates PDF signature', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validPdf, 'document.pdf'),
        isTrue,
      );

      final invalidPdf = Uint8List.fromList([0x00, 0x00, 0x00, 0x00, 0x00]);
      expect(
        FileSignatureUtils.validateFileSignature(invalidPdf, 'document.pdf'),
        isFalse,
      );
    });
    ...
    test('validates JPG signature', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validJpg, 'image.jpg'),
        isTrue,
      );
      expect(
        FileSignatureUtils.validateFileSignature(validJpg, 'image.jpeg'),
        isTrue,
      );

      final invalidJpg = Uint8List.fromList([0x00, 0x00, 0x00]);
      expect(
        FileSignatureUtils.validateFileSignature(invalidJpg, 'image.jpg'),
        isFalse,
      );
    });
    ...
    test('validates PNG signature', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validPng, 'image.png'),
        isTrue,
      );

      final invalidPng = Uint8List.fromList([
        0x00,
        0x00,
        0x00,
        0x00,
      ...
      expect(
        FileSignatureUtils.validateFileSignature(invalidPng, 'image.png'),
        isFalse,
      );
    });
    ...
    test('validates GIF signature', () {
      // GIF87a
      final validGif87a = Uint8List.fromList([
        0x47,
        0x49,
        0x46,
        0x38,
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validGif87a, 'image.gif'),
        isTrue,
      );

      // GIF89a
      final validGif89a = Uint8List.fromList([
        0x47,
        0x49,
        0x46,
        0x38,
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validGif89a, 'image.gif'),
        isTrue,
      );

      final invalidGif = Uint8List.fromList([
        0x00,
        0x00,
        0x00,
        0x00,
      ...
      expect(
        FileSignatureUtils.validateFileSignature(invalidGif, 'image.gif'),
        isFalse,
      );
    });
    ...
    test('validates WEBP signature', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validWebp, 'image.webp'),
        isTrue,
      );
      ...
      expect(
        FileSignatureUtils.validateFileSignature(invalidWebp, 'image.webp'),
        isFalse,
      );
    });
    ...
    test('validates HEIC signature', () {
      ...
      expect(
        FileSignatureUtils.validateFileSignature(validHeic, 'image.heic'),
        isTrue,
      );
      ...
      expect(
        FileSignatureUtils.validateFileSignature(invalidHeic, 'image.heic'),
        isFalse,
      );
    });
