...
void main() {
  testWidgets('SwipeActions exposes Delete custom semantics action', (
    tester,
  ) async {
  ...
  testWidgets('SwipeActions exposes Archive custom semantics action', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets(
    'SwipeActions exposes Unarchive custom semantics action when archived',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
  ...
  testWidgets('SwipeActions exposes both Delete and Archive actions', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
